...
public class TabuaMemberProcessor implements PageProcessor {
    ...
    public void login(){
        ...
        if(e != null) {
            e.click();
            //填写登陆信息
            driver.findElement(By.xpath("//*[@id='cpContent_itemContentCtrl_TabuaLogin_18_txtMembershipNumber']")).sendKeys(getCardNumber());
            driver.findElement(By.xpath("//*[@id='cpContent_itemContentCtrl_TabuaLogin_18_txtPassword']")).sendKeys(getPassword());
